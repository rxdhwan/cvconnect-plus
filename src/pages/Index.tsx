            ...
            <div className="glass-card rounded-lg p-8 shadow-lg">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    { title: "Solana Developer", company: "BlockChain Inc", location: "Remote" },
                    { title: "Blockchain Engineer", company: "CryptoX", location: "New York" },
                    { title: "Smart Contract Auditor", company: "SecureCoin", location: "Berlin" },
                    { title: "Ethereum Architect", company: "DeFi Solutions", location: "Singapore" },
                  ].map((job, i) => (
